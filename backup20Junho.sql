...
--
-- TOC entry 3410 (class 1262 OID 24658)
-- Name: locadora; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE locadora WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Portuguese_Brazil.1252';


ALTER DATABASE locadora OWNER TO postgres;
